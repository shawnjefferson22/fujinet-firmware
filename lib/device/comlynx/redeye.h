...
#define LOGON_DELAY 400*1000  		        // logon countdown timer (us to ms)
#define PLAYER_INACTIVE 1000*1000	        // tolerance of not receiving a player logon packet before removing, (us to ms)
#define COLLISION_BACKOFF 600*1000        // time to let collision resolve itself (us to ms)
#define LOGON_RESTART_BACKOFF 2*1000*1000 // delay time before we can re-enter logon mode (2 seconds, us to seconds)
